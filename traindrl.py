...
#_/_/_/ paths _/_/_/ 
TRAINING_DATA_PATH          = "./datasets/nzts01training.txt"
label_DATA_PATH          = "./datasets/nzts01label.txt"
TESTING_DATA_PATH            = "./datasets/nzts01test.txt"
...
N_EPISODES           = 50 #原始值为30000
EPISODE_LEN = 10
SNAPSHOT_EPISODES  = 10
TEST_EPISODES = 10 #原始值为500，即每隔500次循环进行一次测试
